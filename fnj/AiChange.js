...
function AiPlayersChange() {
  var AiGKList = [
    0x02, 0x0f, 0x21, 0x22, 0x26, 0x33, 0x39, 0x40, 0x4c, 0x52, 0x56, 0x5b,
    0x69, 0x74, 0x76, 0x79, 0x7e, 0x81, 0x84, 0x87, 0x8a, 0x8f, 0x92, 0x97,
    0x9a, 0x9f, 0xa2, 0xa5, 0xa8, 0xab, 0xae, 0xb1, 0xb5, 0xba, 0xbd, 0xc2,
    0xc5,
  ];
...
function outAiStr() {
  ...
  try {
    ...
    var txt1 =
      ...
      ' ' +
      toHex16($('#AiPasslistSelect').get(0).selectedIndex) +
      ' 00';
    ...
    document.getElementById('AIOutStr').innerHTML =
      OutAI_Str +
      '<div><span>If you need to modify the data, use the addresses and data above.</span></div><div><span>The probability data will also have their addresses indicated; please modify carefully.</span></div>';
  } catch {
    //
  }
}
...
function showdiv(x) {
  ...
  switch (x) {
    case 0:
      $('#aiackdiv1').css('display', 'block');
      break;
    case 1:
      $('#aiackdiv2').css('display', 'block');
      break;
    case 2:
      $('#aiackdiv3').css('display', 'block');
      break;
    case 3:
      $('#aidefdiv1').css('display', 'block');
      break;
    case 4:
      $('#aidefdiv2').css('display', 'block');
      break;
    case 5:
      $('#aidefdiv3').css('display', 'block');
      break;
    case 6:
      $('#aiGKdiv1').css('display', 'block');
      break;
    case 7:
      $('#aiGKdiv2').css('display', 'block');
      break;
    case 8:
      $('#aiGKdiv3').css('display', 'block');
      break;
  }
}
...
function ldAIData3(type) {
  ...
  for (var x = 0; x < 4; x++) {
    $('#AiEx2_select_' + (type + 1) + '_' + x).val(
      toHex16(NesHex[地址 + type * 4 + x]),
    );
  }
  GetAIData3(0);
  GetAIData3(1);
